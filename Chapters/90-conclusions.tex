...
% ---------------------------------------------------
To answer \textit{\ref{rq:continuum}: \textit{What are the dimensions/factors/parameters in sharing social experiences on wearable AR devices?}}, we established the concept and dimensions of the social AR continuum (Chapter \ref{ch:continuum}).
