...
This research was limited to measuring social presence, and other subjective standard questionnaires defined by previous literature. Future studies could be extend to capture more data by including qualitative measures (e.g., analysis of recorded conversations) or recording biophysiological data (e.g., heart rate measures), and how would that  
