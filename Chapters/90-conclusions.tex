...
AR offers a specific advantage for social experiences in a way that is contextually adaptable to the current physical surrounding space (here) and the current time (now). This specific feature of \textit{here} and \textit{now} has the potential to enable meaningful sharing of social experiences between people by focusing on the current surroundings and reducing unnecessary distractions.
