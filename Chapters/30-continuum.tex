...
The definnition of these dimension has evolved during this research. It started (Figure \ref{fig:continuum:old-dimensions}) by simply looking at different configurations or options that can be changed when sharing social experiences on an AR headset. The original version focused on two types of social relationships: Friends and Strangers.
...
This is inspried by \textcite{Billinghurst1998} describing the options of the registration of information as head-stabilised, body-stabilised or world-stabilised. 
