...
Scanning a person body in 3D has become more accessible on a consumer scale. For instance, Echo Look by Amazon\footnote{https://en.wikipedia.org/wiki/Amazon\_Echo\#Echo\_Look} is a 3D depth camera that people can use pose in front of, and use AR to overlay different outfits on themselves to see how they would look before purchasing the outfit. The user can share photos of themselves wearing a few outfits with their friends to get feedback on which outfit would look better. 
...
\begin{figure}
    ...
    \caption{Example of avatars in VR. Facebook Spaces \cite{Facebook}}
...
Few techniques can be used to enhance social presence in 360-degree videos. 360-degree video can be combined with a 3D reconstructed environment to enable the user to switch between 360 and 3D for remote collaboration purposes \cite{Teo2019}. This technique can be applicable for sharing social experiences of surrounding space. A multi-scale representation of avatars inside a 360-degree video has been found to be a good design for user interactions \cite{Piumsomboon2019OnInteraction}. Participants can be represented either as a giant or a miniature in the shared 360-degree video environment depending the context of the collaboration. Representing avatars for remote collaboration purposes has been studied in \cite{Kolkmeier2018WithSystems} where they built an open source system using depth camera and HoloLens to share the room and the avatar in an immersive way which found higher social presence in high fidelity immersive VR experience. However, higher fidelity of virtual avatars is not always better for presence and embodiment. \textcite{Regenbrecht2017} demonstrated the concept of voxel mixed reality experience where a low-fidelity coarser representation of human would achieve good results in presence between participants. 
...
\begin{figure}
    ...
    \caption{Example of avatars in AR - Avatar Chat by Magic Leap \cite{MagicLeapAvatarChat}}
...
This work builds on previous work on proximity-based relationships \cite{Sousa2016} and focuses on the shared contents of social avatars in an asynchronous situation. Unlike previous work on social avatars, this thesis studies representing social contacts in a large-scale network. This work aims to reduce the clutter that may be caused by displaying social avatars and their shared content. This thesis addresses the question of how we can use the social relationship between avatars and the viewer as a way to filter and enhance viewing the shared-content experiences. 
...
The trends in the past work indicate that wearable AR has been the target of many previous developments and research directions. Aiming to enable true outdoor experiences and to be untethered to physical places would allow more exploration of the surrounding world. 
