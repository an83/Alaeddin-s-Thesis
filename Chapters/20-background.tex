...
\todo[inline]{You may need to add older works, such as, Steve Feiner’s Touring Machine.
This section seems very short to cover all history of Wearable AR? Maybe you want to change to the title to make it clearer you’re only focusing on wearable AR based collaboration?
Also seems quite overlapping with 2.2 and 2.5, so another option would be to merge them?}

\todo[inline]{You should have a paragraph summarizing the trend in the past work and what is the limitation to support why your work is important. Or you may add a section at the end of this chapter that does an overall review of the whole chapter and describe how your thesis makes contribution to the current state-of-the-art.}
...
\todo[inline]{Gun: This is not about annotations anymore? Better move to 2.5? or another option (or maybe a better option) would be merging this whole section with 2.5, as “annotation” itself is a bit off from your scope but only a part of?}
...
\todo[inline]{Gun: Again, not sure how you would draw line between this section and 2.5 (Remote Collaboration)?}
...
\todo[inline]{Thesis should rather have more completeness. Yes there could be future work left out, but you shouldn’t say it is a work in progress. Clarifying the scope of your thesis in the introduction section may help.}

\todo[inline]{
    Gun: Would be good to have a section summarizing the overall chapter and clarifying the need of your research. After reading the chapter the reader should be convinced and have clear idea on what is the current state-of-the-art, what are the missing pieces/limitations that this thesis is trying to contribute.
}
