...
360-degree video can be combined with a 3D reconstructed environment to enable the user to switch between 360 and 3D for remote collaboration purposes \cite{Teo2019}. This technique can be applicable for sharing social experiences of surrounding space. 
