...
The primary goal of this thesis is to explore, develop and evaluate novel interaction techniques for Augmented Reality (AR) wearable headsets, focusing on how they can be used to share social experiences with our family and friends. AR has the potential to fulfil the need for an intuitive and natural approach to sharing our social experiences in life that increase our social and co-presences. With a design framework for visualising and interacting with social networks on wearable AR devices, this work discusses the advantages and limitations of various implementations and techniques of shared social experiences on wearable AR.  
