...
The primary goal of the work reported in this thesis is to explore, develop and evaluate novel interaction techniques for Augmented Reality (AR) wearable headsets, focusing on how they can be used to share social experiences with family and friends. AR has the potential to provide an intuitive and natural approach to sharing our social experiences in life with others while being co-present. With a design framework for visualising and interacting with social networks on wearable AR devices, this work discusses the advantages and limitations of various implementations and techniques of shared social experiences on wearable AR.  

Based on Human-Computer Interaction methodologies, this work developed and ran user studies to evaluate user presence and system usability of our implementation in visualising, sharing and interaction of social experiences on AR headsets. This thesis focused on the essential dimensions of "representing contacts", "sharing data" and "interactions", and developed user interfaces on these dimensions and evaluated them using user studies. 
