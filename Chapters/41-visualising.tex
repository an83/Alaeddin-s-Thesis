...
\begin{figure}[h]
  \includegraphics[width=\linewidth]{images/mgia17/20170618_031128_HoloLens_cropped.jpg}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\linewidth]{images/mgia17/silhouettes.PNG}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\linewidth]{images/mgia17/avatars.PNG}
...
For \textit{Task 2} (Figure \ref{fig:contacts:visual-fidelity}), participants were asked to order friend categories based on proximity (distance from the user). Most (90\%) participants ordered the categories as follows: Intimate, Friend, Acquaintance, Stranger on the scale from closest to furthest away from the user. This shows that users associated proximity to intimacy. Only 9\% chose: Intimate, Stranger, Friend, Acquaintance. 
