...
For \textit{Task 1}, when asked about how they would imagine representing social contacts in an AR platform, there were two main recurring themes, listed in order of popularity. Figure \ref{fig:contacts:focus-group} shows 

\begin{figure}[ht]
    \centering
    \includegraphics[width=0.8\linewidth]{images/41-visualising-mgia17/focus-group/Snapchat-662026893.jpg}
    \includegraphics[width=0.8\linewidth]{images/41-visualising-mgia17/focus-group/Snapchat-1596596995.jpg}
    \includegraphics[width=0.8\linewidth]{images/41-visualising-mgia17/focus-group/Snapchat-1574295232.jpg}
