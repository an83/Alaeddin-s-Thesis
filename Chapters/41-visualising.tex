...
As part of the Social AR Continuum, representing self and others social contacts is one of the main dimensions. This section explores representing social contacts in a form of avatars in AR. 


\todo[inline]{Transition ... make it better}

In the previous chapter we have presented the concept of the social AR continuum together with examples for its relevance. We identified the representation of social contacts as one of the main dimensions within our social AR continuum. Here, we distinguish in particular how to present social contacts (e.g. visual fidelity) and where to present them (spatial mapping such as proximity). Within this chapter we will expand this by focusing exactly on this dimension and exploring different visualisation types along this dimension. We are in particular interested in ……. Our main hypothesis are……. If confirmed, we would be able to infer that…….

One of the issues with representing contacts from social networks in AR is how to differentiate between the contacts. This section explores how visual and spatial cues based on social relationships can be used to represent contacts in social AR applications, making it easier to distinguish between them  \cite{Nassani2017b}. This section explores how to visualise social relationships in mobile AR environments using proximity and visual fidelity filters. A focus group was organised to explore different options for representing social contacts in a mobile AR application. Also, a user study was conducted to test a head-worn AR prototype using proximity and visual fidelity filters. This section discusses the results of the focus group and the user study and provide insights into directions for future work.
...
\todo[inline]{Inspiration from web based social networks}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.8\linewidth]{images/mgia17/writing-images-07.eps}
...
The focus group began with a discussion and brainstorming session on how to visualise social network contacts in an AR environment. The concept of social networking in AR was briefly introduced. Few challenges were observed, such as visual clutter, but no demonstration of the prototype system was given to avoid priming. This activity included three tasks: 
...
\textit{Task 1}: The participants were asked to draw or describe their vision of the future of how to represent social networks in AR. They then presented their ideas to the group and exchanged feedback.

\textit{Task 2}: The participants were asked to order four different social groups (Intimate, Friend, Acquaintance, Stranger) in terms of physical distance from the user. Participants were gaven  four silhouettes on paper that had one of the social groups written on the top and asked them to place them on an arrow that had four positions; closest, close, far and farthest.

\textit{Task 3}: The participants were asked to match four different types of visual fidelity (3D avatar, 2D image, Bust image, Emoji) to four social groups (Intimate, Friend, Acquaintance, Stranger). This task included two sets of avatars, male and female.
...
For \textit{Task 2} (Figure \ref{fig:contacts:visual-fidelity}), participants were asked to order friend categories based on proximity (distance from the user). Most (90\%) participants ordered the categories as follows: Intimate, Friend, Acquaintance, Stranger on the scale from closest to furthest away from the user. This shows that users associated proximity with intimacy.
...
For \textit{Task 3} 
(Figure \ref{fig:contacts:proximity}), participants were asked to categorise four types of visual fidelity. Most participants (73\%) associated 3D avatars with an Intimate relationship, 59\% marked the 2D image as a  Friend, 64\% associated the bust image for Acquaintances, while 45\% marked emoji for Strangers.
...
The SUS scores (Figure \ref{fig:contacts:sus}), show conditions B (69), V (69) and C (72) are rated "Good" while B is "OK" (67). To see if this difference was statistically significant, aligned rank transform was run on the SUS results in order to run a 2-way repeated measure ANOVA analysis with two factors Proximity and Visual Fidelity. No significant differences were found in terms of SUS between Proximity and Visual Fidelity. 
