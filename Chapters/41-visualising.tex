...
\begin{figure}[h]
    ...
    \caption{Examples of representing social contacts on mobie and web social networking apps. Left to right: Facebook, LinkedIn, Snapchat avats on map, Snapchat AR Len}
