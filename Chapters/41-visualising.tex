...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.2\linewidth]{images/41-visualising-mgia17/Screenshot_20190805-222553.png}
    \includegraphics[width=0.2\linewidth]{images/41-visualising-mgia17/Screenshot_20190805-222912.png}
    \includegraphics[width=0.2\linewidth]{images/41-visualising-mgia17/Screenshot_20190805-225235.png}
    \includegraphics[width=0.2\linewidth]{images/41-visualising-mgia17/Screenshot_20190805-225545.png}
    \caption{Examples of representing social contacts on mobie and web social networking apps. Left to right: Facebook, LinkedIn, Instagram and Snapchat}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.2\linewidth]{images/41-visualising-mgia17/Screenshot_20190806-233031.png}
    \includegraphics[width=0.2\linewidth]{images/41-visualising-mgia17/Snapchat-1648293704.jpg}
    \includegraphics[width=0.2\linewidth]{images/41-visualising-mgia17/Screenshot_20190806-234430.png}
    \caption{Bitmoji avatar usage in social networking apps. Left to right: Snapchat map, Snapchat AR lens and Bitmoji messages}
    \label{fig:contacts:inspiration-2}
\end{figure}
...
It is assumed here that the level of realism is the same between 3D avatar, 2D image, Bust image and Emoji. The only difference is the level of detail in representing the virtual avatar.

\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\linewidth]{images/41-visualising-mgia17/writing-images-07.eps}
...
In some cases, the user may choose a different visual fidelity for a different social proximity group. For instance, the user while at work prefers to see intimate relationships represented as emojis, while acquaintances represented as 3D avatars. 
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.8\linewidth]{images/41-visualising-mgia17/focus-group/focus-group-01.eps}
...
When rendering virtual avatars, there is a potential Uncanny Valley\footnote{\url{https://en.wikipedia.org/wiki/Uncanny_valley}} effect. However, this effect was not studied as part of this work as the focus was on the levels of detail of representing social contacts. Also, the virtual avatars did not resemble any of the participants' real social contacts.
