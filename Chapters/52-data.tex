...
\begin{figure}[ht]
    ...
    \caption{Social contact sharing in different relationships with the viewer. (Left to right: Intimate, Friend, Stranger). The shared data content (top of avatar) is filtered out (360-degree video, 2D video, 2D image) based on social relationship.}
...
\begin{figure}[ht]
    ...
    \caption{Social contact sharing in different relationships with the viewer. (Left to right: Intimate, Friend, Stranger). The shared data content (above the avatar) is filtered out (360-degree video, 2D video, 2D image) based on social relationship.}
