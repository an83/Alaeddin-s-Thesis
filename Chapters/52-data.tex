...
This prototype used asynchronous sharing, where social contacts were not online at the same time, sharing live data. The shared content wass previously prepared, and the 360 videos is previously processed to extract a 2D video and a 2D image. However, the method we applied for filtering could be applied to synchronous sharing as well. In the future, we will add live video streaming from social contacts and live scaling down the contents based on social relationships. 
