...
The social data describing the surrounding scene can described in different levels of detail. Levels of detail include a text describing the scene, a 2D image, a panoramic image, a video, a 360-degrees video, a 3D depth image, or a VR 3D model. All these levels of detail can describe the same scene 
