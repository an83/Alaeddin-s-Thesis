...
Desipte adding higher fidelity of annotation (drawing or pointing), in this specific platform (Glass), it did not lead to higher social presence. This indicates that social presence is also dependant on a platform that supports the interaction method in good usability to gain the benefit of increased . 
