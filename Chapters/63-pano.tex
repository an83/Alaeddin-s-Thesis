...
There was no difference in Social Presence depending on the interaction tools that were being used. However, there was a clear preference from users for pointing tools, but drawing in the Glass touchpad was difficult and ranked very low in usability. These results show that effective shared social experiences can be developed with panorama imagery, but more work still needs to be done. 
