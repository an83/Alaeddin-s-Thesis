...
\begin{figure}[h]
  ...
  \caption{System workflow of AR Annotation using 3D sensors. Google Glass detects user voice input for the annotation text content. The AR viewpoint is calculated based on the head rotatio}
...
\begin{figure}
  \centering
  \includegraphics[width=0.6\linewidth]{images/mgia15/WIN_20150614_204531_2.jpg}
...
\begin{figure}
  \centering
  \includegraphics[width=0.6\linewidth]{images/mgia15/axis_lo_small.jpg}
