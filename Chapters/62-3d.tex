...
Since the development of this system, there has been newer devices available. If this work was implemnted with a HoloLens\footnote{\url{https://en.wikipedia.org/wiki/Microsoft_HoloLens}} or Magic Leap\footnote{\url{https://en.wikipedia.org/wiki/Magic_Leap}} there will be no need for Google Tango as the current AR headset devices integrates 3D depth sensors in the AR display. The focus of the study will shift to study different levels of interactions based on the Social AR Continuum. For instance, a close friend may be able to maniuplate the 3D AR Annotation, while an aquaintance or friend may only be able to read or comment on the existing annotations. 