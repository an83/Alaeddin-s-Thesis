...
The system described in this was designed and implemented in 2014. 
You may want to mention that the capabilities that you showed here are all combined into new AR HMD such as Hololens or MagicLeap. If you were to do the project again today you could do this on the MagicLeap display with no additional hardware.
