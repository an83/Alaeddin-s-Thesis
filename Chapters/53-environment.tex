...
\begin{figure}[ht]
  \centering
  \includegraphics[width=.8\linewidth]{images/53-environment-ismar18/images-14.eps}
  \caption{Top: the average results of subjective comfort questions. Bottom-left: the percentage results of ranking the best condition. Bottom-right: the percentage results of voting for the best method to hide part of the environment. Whiskers indicate the standard error.}
