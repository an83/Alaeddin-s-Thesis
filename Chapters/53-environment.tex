\section{Filtering 3D Shared Surrounding Environments by Social Proximity in AR}

% =============== PREVIOUS WORK ================

% A. Nassani, H. Bai, G. Lee, M. Billinghurst, T. Langlotz, and R. W. Lindeman, “Filtering 3D Shared Surrounding Environments by Social Proximity in AR,” in ISMAR 2018, 2018, vol. 1, pp. 1–2.
...
% With 3D scanning and reconstruction technology becoming available and easy to use on wearable AR devices, people would like to share their surrounding environments (e.g., a living room, work place, etc.) captured in 3D with their social contacts. As a vision for the future representation of social networks on wearable AR, the Social AR Continuum \cite{Nassani2017a} listed various dimensions where social experiences could be shared via AR displays. This work extends on the dimension of sharing surrounding environment by using social proximity to vary the level of detail of the surrounding environment shared with others. 

% Social proximity has been used before \cite{Sousa2016, deSousa2014} by defining a gradual engagement model for remote sharing based on physical distance between people, to define layers around the sharer based on how close they are to each other, and how users interact with each other in each of these layers. 
