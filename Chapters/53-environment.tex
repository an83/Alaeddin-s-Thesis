...
This section explored implementing the Social AR Continuum on sharing surrounding spaces between social contacts as one of the dimensions on the social data category. A user study was run to test the effects of applying a filter on levels of detail on how comfortable the participants were in terms of privacy. Results found that most participants are more comfortable when the social filter was applied to their shared surrounding environment which aligns with the promise of the Social AR Continuum that filtering based on social proxmity . 