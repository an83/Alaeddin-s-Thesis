...
AR annotation is an example of the interaction dimension on the Social AR Continuum. The attachment of these annotations can be represented in different level of detail (attached vs unattached) which can be mapped based on the social proximity. For instance, attached AR annotations on a particual object or a person can be used for Intimate type of social relationship while unattached annotations as a list of text annotations can be used for Friend or Stranger types of social relationship.
