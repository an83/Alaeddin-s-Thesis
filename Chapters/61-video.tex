...
AR annotation is an example of the interaction dimension on the Social AR Continuum. The registration (e.g., world-stabilised, body-stabilised and head-stabilised \cite{Billinghurst1998}) of these annotations with respect to the user (viewer or sharer) can be represented in different level of detail  which can be mapped based on the social proximity. For instance, world-stabilised annotation can be used for Intimate type of social relationship while body-stabilised for Friend and head-stabilised for Stranger.
...
% For Q1, there was a statistically significant difference in the perceived message understanding ($\chi^2(2)=19.263, p<0.001$). Post-hoc analysis found there was significant differences between L and AR ($Z=-2.986, p=0.003$) and between L and L+AR ($Z=-3.256, p=0.001$) while there was no statistically significant difference between AR and L+AR ($Z=-0.543, p=0.587$).
% For Q2, there was a statistically significant difference in the perceived message understanding ($\chi^2(2)=12.552, p=0.002$). Post-hoc analysis found there was significant differences between L and AR ($Z=-3.024, p=0.002$) and between L and L+AR ($Z=-3.147, p=0.002$) while there was no statistically significant difference between AR and L+AR ($Z=-0.180, p=0.857$).
% For Q3, there was a statistically significant difference in the perceived message understanding ($\chi^2(2)=14.436, p=0.001$). Post-hoc analysis found there was significant differences between L and AR ($Z=-2.796, p=0.005$) and between L and L+AR ($Z=-3.132, p=0.002$) while there was no statistically significant difference between AR and L+AR ($Z=-0.212, p=0.832$).
