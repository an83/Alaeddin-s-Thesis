...
\todo[inline]{Check grammar}
\todo[inline]{justify choices}
...
Thin work includes implementing three different interfaces to display comments: (1) List, (2) Augmented Reality (AR), and (3) List + AR (see Figure \ref{fig:mgia16:conditions}).
...
20 participants (11 female, aged between 19 and 35 years old, Median=27.5, SD=4.55) were recruited to participate in the user study. Most (95\%) of them had experience with live video streaming a few times a week to a few times per month and 80\% were familiar with AR applications. A non-parametric Friedman test was run for all the results with alpha=0.05, and post-hoc tests using Wilcoxon signed-rank tests with the Bonferroni correction ($alpha=0.017$).
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.8\linewidth]{images/mgia16/sus.eps}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.8\linewidth]{images/mgia16/message.eps}
  \includegraphics[width=0.8\linewidth]{images/mgia16/affective.eps}
