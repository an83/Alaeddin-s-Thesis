...
For Q1, there was a statistically significant difference in the perceived message understanding ($\chi^2(2)=19.263, p<0.001$). Post-hoc analysis found there was significant differences between L and AR ($Z=-2.986, p=0.003$) and between L and L+AR ($Z=-3.256, p=0.001$) while there was no statistically significant difference between AR and L+AR ($Z=-0.427, p=0.670$)
