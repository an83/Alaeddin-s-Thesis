...
For Q3, there was a statistically significant difference in the perceived message understanding ($\chi^2(2)=14.436, p=0.001$). Post-hoc analysis found there was significant differences between L and AR ($Z=-3.024, p=0.002$) and between L and L+AR ($Z=-3.147, p=0.002$) while there was no statistically significant difference between AR and L+AR ($Z=-.212, p=0.857$).
