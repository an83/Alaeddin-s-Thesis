...
AR annotation is an example of the interaction dimension on the Social AR Continuum. The registration (e.g., world-stabilised, body-stabilised and head-stabilised \cite{Billinghurst1998}) of these annotations with respect to the user (viewer or sharer) can be represented in different level of detail  which can be mapped based on the social proximity. For instance, world-stabilised annotation can be used for Intimate type of social relationship while
