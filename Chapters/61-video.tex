...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{images/mgia16/social-presence.eps}
  \caption{Results for the social presence questions "perceived message understanding" and "perceived affective understanding". Whiskers indicate standard error. *=statistical differe }
...
\begin{figure}[H]
  \centering
  \includegraphics[width=.8\linewidth]{images/mgia16/ranking.eps}
