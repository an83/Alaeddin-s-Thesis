...
For Task 2, Figure \ref{fig:frontier18:result-hiding} shows the Likert scale results for the viewer and the sharer comparing three hiding mechanisms. A Wilcoxon signed-rank test on the results of \textit{Task 2} comparing hiding mechanism of 1) remove (T2C1), 2) overlay (T2C2) showed that as a viewer having a social filter (T1C2) did elicit a statistically significant difference
