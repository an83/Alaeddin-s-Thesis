...
The results show statically significant difference when comparing social filter over no filter in a few bi-polar questions for the viewer side and in a few co-presences questions for the sharer side.

The ranking results show that having the social filter was preferred over no social filter. However, in the Likert questions, a statistical differences was found in only 5 questions out of 15. Participants with the sharer point of view had more statistical differences than those with the viewer point of view. This indicates that having a social filter is essential for people to feel comfortable regarding privacy when they have to choose, but not as much when they have to go through the effort of selecting which objects to hide for each social relationship.  
