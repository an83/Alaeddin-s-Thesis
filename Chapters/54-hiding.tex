...
S3  & Not-Interested-Interested\\
    \end{tabular}
    \caption{The subjective questions participants were asked to rate their experience on a 7-point Likert scale (1 = strongly disagree or negative, 7 = strongly agree or pos)}
    \label{tabitive:frontier18:questions}
\end{table}
