...
This section describes a system and a user study for sharing social surrounding spaces on wearable AR devices. Unlike sharing for collaborative purposes, we focus on sharing between social contacts. We extend the previous work of the AR Social Continuum by exploring how sharing the surrounding environment can vary based on the social proximity between social contacts. We built a prototype for sharing a 3D captured room on a HoloLens, which enables the user to display three levels of social relationships: Intimate, Friend and Stranger, and maps them to three levels of the surrounding environment. 
...
We allowed users to choose which part of the room to hide or show to different social groups (Intimate, Friend, Stranger). We ran a user study to test the effects of using a social filter on co-presence and feelings of privacy from both sides, as a sharer and a viewer. We found that all participants preferred having a social filter, and that there was some statistical difference regarding feelings of co-presence and privacy. 
