...
% This thesis explores how multiple people would use social AR to connect the shared virtual space and interaction techniques. 
...
\begin{enumerate}[label=RQ\arabic*]
    ...
    % \\(option 5): What is the impact on the social presence of different visualisation methods for social contacts?
    }
