...
This chapter studies: 1) different types of representing shared social data (e.g., 2D photo, 360-degrees images, and 3D surrounding environment) \ref{sec:surrounding:360}, 2) the different levels of detail and resolution of 3D surrounding environments as a type of shared social data \ref{sec:surrounding:environment}, and 3) the hiding mechanism and sense of privacy when sharing social surrounding space between social contacts in section \ref{sec:surrounding:hiding}.   
