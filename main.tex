...
\usepackage{enumitem}
\usepackage[backend=bibtex,style=numeric,natbib=true,doi=false,isbn=false,url=true,maxbibnames=9,maxcitenames=1,sortcites=true,sorting=nyt]{biblatex} 
\usepackage{booktabs}
...
\addbibresource{references2.bib} % mendeley
...
\noindent\enquote{\itshape If ever there is a tomorrow when we're not together... there is something you must always remember.\\
...
\input{Chapters/02-acknowledgement.tex}
...
\input{Chapters/30-continuum}
\input{Chapters/40-contacts}
\input{Chapters/50-surrounding}
\input{Chapters/60-interaction}
\input{Chapters/90-conclusions}
